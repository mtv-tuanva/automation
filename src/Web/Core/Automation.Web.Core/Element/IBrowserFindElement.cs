...
namespace Automation.Web.Core
{
    public interface IBrowserFindElement
    {
        ...
        IWebElement FindElement(string selector, SelectorType selectorType = SelectorType.CssSelector, int selectIndex = 0);
        ...
        IWebElement FindElementByClassName(string className, int selectIndex = 0);
        ...
        /// <param name="selectIndex">The index of element that you want to select. Default is 0.</param>
        /// <returns>The first OpenQA.Selenium.IWebElement matching the criteria.</returns>
        IWebElement FindElementByCssSelector(string cssSelector, int selectIndex = 0);
        ...
        /// <param name="selectIndex">The index of element that you want to select. Default is 0.</param>
        /// <returns>IWebElement object so that you can interact with that object</returns>
        IWebElement FindElementById(string id, int selectIndex = 0);
        ...
        IWebElement FindElementByLinkText(string linkText, int selectIndex = 0);
        ...
        /// <param name="selectIndex">The index of element that you want to select. Default is 0.</param>
        /// <returns>IWebElement object so that you can interact that object</returns>
        IWebElement FindElementByName(string name, int selectIndex = 0);
        ...
        /// <param name="selectIndex">The index of element that you want to select. Default is 0.</param>
        /// <returns>IWebElement object so that you can interact that object</returns>
        IWebElement FindElementByPartialLinkText(string partialLinkText, int selectIndex = 0);
        ...
        /// <param name="selectIndex">The index of element that you want to select. Default is 0.</param>
        /// <returns>IWebElement object so that you can interact that object</returns>
        IWebElement FindElementByTagName(string tagName, int selectIndex = 0);
        ...
        /// <param name="selectIndex">The index of element that you want to select. Default is 0.</param>
        /// <returns>IWebElement object so that you can interact that object</returns>
        IWebElement FindElementByXPath(string xpath, int selectIndex = 0);
        ...
        ReadOnlyCollection<IWebElement> FindElements(string selector, SelectorType selectorType = SelectorType.CssSelector);
        ...
        SelectElement FindSelectElement(string selector, SelectorType selectorType = SelectorType.CssSelector, int selectIndex = 0);
    }
}
